                ...
                <div class="modal-body">
                    <form id="editForm{{$b->idabsen}}" action="/absen/update/{{$b->idabsen}}" method="post">
                        ...
                        <div class="form-group m-2">
                            ...
                            <input type="text" class="form-control" id="jumlah_jam" name="jumlah_jam" value="{{ $b->jumlah_jam }}" required>
                        </div>

                        <div class="form-group m-2">
                            <label>Jumlah Hari :</label>
                            <input type="text" class="form-control" id="jumlah_hari" name="jumlah_hari" value="{{ $b->jumlah_hari }}" required>
                        </div>
